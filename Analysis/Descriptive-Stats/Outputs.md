...
> **Next steps: These outputs also show that it probably would be helpful to compound more terms, specially key names (Jim Crow, John Lewis, Nance Pelosi, Kris Kobach, etc), I went back to pre-processing here.
